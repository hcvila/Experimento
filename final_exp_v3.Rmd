...
# V3
PARAM$finalmodel$optim$num_iterations <- 551
PARAM$finalmodel$optim$learning_rate <- 0.046949
PARAM$finalmodel$optim$feature_fraction <- 0.989362
PARAM$finalmodel$optim$min_data_in_leaf <- 21708
PARAM$finalmodel$optim$num_leaves <- 1970
