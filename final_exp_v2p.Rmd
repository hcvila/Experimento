...
PARAM$finalmodel$optim$learning_rate <- 0.055829
PARAM$finalmodel$optim$feature_fraction <- 0.945632
PARAM$finalmodel$optim$min_data_in_leaf <- 19710
PARAM$finalmodel$optim$num_leaves <- 2047
