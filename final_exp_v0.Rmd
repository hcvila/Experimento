...
# V0
PARAM$finalmodel$optim$num_iterations <- 317
PARAM$finalmodel$optim$learning_rate <- 0.074714
PARAM$finalmodel$optim$feature_fraction <- 0.459830	
PARAM$finalmodel$optim$min_data_in_leaf <- 1389
PARAM$finalmodel$optim$num_leaves <- 143
