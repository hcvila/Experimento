...
# V1
PARAM$finalmodel$optim$num_iterations <- 401
PARAM$finalmodel$optim$learning_rate <- 0.085495
PARAM$finalmodel$optim$feature_fraction <- 0.569121
PARAM$finalmodel$optim$min_data_in_leaf <- 20736
PARAM$finalmodel$optim$num_leaves <- 1040
