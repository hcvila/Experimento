...
# V3p
PARAM$finalmodel$optim$num_iterations <- 992
PARAM$finalmodel$optim$learning_rate <- 0.022016
PARAM$finalmodel$optim$feature_fraction <- 0.999240
PARAM$finalmodel$optim$min_data_in_leaf <- 1373
PARAM$finalmodel$optim$num_leaves <- 1142
