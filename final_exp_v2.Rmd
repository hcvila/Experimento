...
# V2
PARAM$finalmodel$optim$num_iterations <- 2107
PARAM$finalmodel$optim$learning_rate <- 0.020453
PARAM$finalmodel$optim$feature_fraction <- 0.905700
PARAM$finalmodel$optim$min_data_in_leaf <- 12082
PARAM$finalmodel$optim$num_leaves <- 895
