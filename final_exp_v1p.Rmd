...
PARAM$finalmodel$optim$learning_rate <- 0.052331
PARAM$finalmodel$optim$feature_fraction <- 0.837518
PARAM$finalmodel$optim$min_data_in_leaf <- 17253
PARAM$finalmodel$optim$num_leaves <- 1114
