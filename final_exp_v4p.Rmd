...
```{r}
PARAM <- list()
PARAM$experimento <- "exp_final"
PARAM$nombreexp <- "V4p_2"
...
# V4p
PARAM$finalmodel$optim$num_iterations <- 886
PARAM$finalmodel$optim$learning_rate <- 0.043068
PARAM$finalmodel$optim$feature_fraction <- 0.921907
PARAM$finalmodel$optim$min_data_in_leaf <- 15182
PARAM$finalmodel$optim$num_leaves <- 2044
...
if (TRUE) {  # Si se quiere borrar información de la pandemia
